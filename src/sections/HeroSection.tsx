...
export default function HeroSection() {
  ...
  >
      ...
      <div className="overflow-hidden mt-2 sm:mt-8 md:mt-4">
        <FadeIn delay={0.1} y={40}>
          <h1 className="hero-heading font-black uppercase tracking-tight leading-none whitespace-normal md:whitespace-nowrap w-full text-[14vw] sm:text-[15vw] md:text-[16vw] lg:text-[13.97vw]">
            Hi, i&apos;m mannan
          </h1>
        </FadeIn>
      </div>
  ...
  className="absolute left-1/2 -translate-x-1/2 z-10 bottom-18 md:bottom-0 w-[380px] sm:w-[420px] md:w-[560px] lg:w-[700px] xl:w-[900px]"
>
